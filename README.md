...
│   │                             fit (gitignored; {nominal,scale_vars,BEC,sw2,
│   │                             pseudo}/ subdirs)
...
│       └── output_xsec/        - pre-computed σ-template input files for the
│                                 fit (gitignored; {nominal,BEC}/ subdirs)
├── scripts/
...
INPUT_DIRS = {"nominal": "process/wbwb/output_xsec/nominal", "BEC": "process/wbwb/output_xsec/BEC", ...}
...
python ../../../compute_xsec_wbwb.py --ncores 8 --outdir ../output_xsec/nominal
```
