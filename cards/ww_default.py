...
# ---------------------------------------------------------------------------
INPUT_VAR = {
    "BEC":  10.0,    # MeV — matches output_xsec_ww/BEC/scan_{p,m}10/
    "BES":  0.1,
...
# ---------------------------------------------------------------------------
INPUT_DIRS = {
    "nominal":    "output_xsec_ww/nominal",
    "scale_vars": "output_xsec_ww/scale_vars",
    "BEC":        "output_xsec_ww/BEC",
    "pseudo":     "output_xsec_ww/pseudo",
}
