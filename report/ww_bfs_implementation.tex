...
\item \textbf{NLL ISR.} The remaining residual after fixing the recipe
  details above is the BFS-quoted $\delta\mW\!\approx\!31\MeV$ ISR
  systematic. The NLL upgrade (analytic Skrzypek-Jadach or
  eMELA-based, cf.~\cite{eMELA2019}) is the principled path to
  shrinking this. It also has the practical advantage of being
  WHIZARD-version-independent: the LL$+$exp$+$NLL recipe is fully
  in-process. See the project followup in the team memory log
  for scope.
