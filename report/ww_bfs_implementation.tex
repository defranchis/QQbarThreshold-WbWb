...
closure at $(\mW,\mt,M_H,M_Z)=(80.377,174.2,115,91.188)\GeV$:
...
\toprule
 & $\partial/\partial\mW$ [/GeV] & $\partial/\partial\mt$ [/GeV] & $\partial/\partial M_H$ [/GeV] \\
\midrule
...
zero by construction. $\mt$ and $M_H$ slopes are $\mathcal{O}(10^{-3})$
...
\item \textbf{$(\mW,\mt,M_H)$ dependence of $c^{(1,\mathrm{fin})}$.}
  ...
  $(\mW,\mt,M_H,M_Z)$ slopes into the fit. Dominant slope
