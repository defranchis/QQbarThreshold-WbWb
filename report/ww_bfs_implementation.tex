...
$+0.29\GeV^{-2}$ at $\sqrts\simeq160.5\GeV$ and decaying to zero away
...
$+0.29\GeV^{-2}$ at the rise; $R_m$ and $R_\Gamma$ are the $m_W$ /
...
$\sqrts$ and averaging $\sigma_0$ across the $(\mW,\GammaW)$ plane, so
the morph carries the smooth zero-line curve.}
\label{fig:mv-sqrts}
\end{figure}
...
width $\sim$1.24, demonstrating the morph prediction is
...
limited (median $0.005\,\%$, max $0.083\,\%$); the spikes at the two
...
$0.144\,\%$ on Table~2); the morph/BFS ratio tracks the raw-grid/BFS
