...
\begin{tabular}{r r r r}
\toprule
$\sqrts$ & code/BFS Table~4 NLO (OFF) & code/BFS (ON) & $\Delta$ \\
{}[GeV]  & (historical chain)         & (BFS recipe)  & [pp] \\
\midrule
158 & $0.971$ & $0.979$ & $+0.9$ \\
161 & $0.991$ & $0.995$ & $+0.4$ \\
164 & $0.997$ & $0.999$ & $+0.2$ \\
...
\bottomrule
\end{tabular}
\\[2pt]\small \emph{Scenario~F closure to BFS Table~4 NLO column,
historical chain (knob OFF) vs BFS recipe (knob ON = production
default).}\label{tab:val-table4-decay-on}
\end{center}
