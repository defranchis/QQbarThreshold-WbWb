...
Between grid $\sqrts$ the eight morph quantities are carried by natural cubic splines through the denoised grid. Fig.~\ref{fig:mv-sqrts} contrasts the raw per-$\sqrts$ fit with the denoised curve actually used, Fig.~\ref{fig:mv-sqrtsval} is a blind test on the half-step densify points, and Fig.~\ref{fig:mv-4dloo} the leave-one-out cross-check.
