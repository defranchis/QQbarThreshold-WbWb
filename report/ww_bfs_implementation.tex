...
2026-05-27). Production defaults are PDG-current
($\alpha_s(\mW)=0.1199$, $m_t=174.2\GeV$, $M_H=125.25\GeV$,
$M_Z=91.1876\GeV$). The closure scripts of
...
$z_\text{min}=0.30$, $n_\text{quad}=128$ per leg --- picked by a
dedicated convergence study (max relative residual
$\sim\!3\times 10^{-4}$ at WW threshold, scheme-independent); tighter
$z_\text{min}$ wastes Gauss-Legendre nodes on the empty region below
the kinematic threshold $z_{\rm kin}\!\approx\!0.985$ where
$\hat\sigma$ vanishes. The size of the residual $\mW$ bias from
